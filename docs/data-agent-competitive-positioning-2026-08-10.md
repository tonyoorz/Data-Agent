...
**Date:** 2026-08-10
**Scope:** Current `codex/industry-capability-hardening` integration branch, its isolated implementation worktrees, current product documentation, and official vendor documentation fetched on this date.
